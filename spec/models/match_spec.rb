    ...
    it 'will format the match data correctly upon being asked' do
      expect(@match.format_match([@winner,
                                  @loser])).to eq({ 'match ID' => nil, 'winner name' => 'John Jones',
                                                    'loser name' => 'Joan Johnson', 'winner rating' => 800, 'winner rank' => 'Unranked', 'winner global ranking' => 1, 'loser rating' => 800, 'loser rank' => 'None', 'loser global ranking' => 1, 'played at' => nil })
    end
  end
